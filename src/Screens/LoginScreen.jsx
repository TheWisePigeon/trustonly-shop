    ...
    <>
      <div className="flex items-center justify-center text-center pt-8 ">
        <form novalidate="" action="" className="flex flex-col w-full max-w-lg p-12 rounded shadow-lg  ">
          ...
          <button type="submit" className="flex items-center justify-center h-12 px-6 mt-8 text-sm font-semibold rounded bg-emerald-400 text-white ">Sign In</button>
          <div className="flex justify-center mt-6 space-x-2 text-xs ">
            <Link rel="noopener noreferrer" to="/recover" className="">Forgot Password?</Link>
            <span className="">/</span>
            <Link rel="noopener noreferrer" to="/register" className="">Sign Up</Link>
          </div>
        </form>
      </div >
    </>
